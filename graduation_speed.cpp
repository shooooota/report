...
int main()
{
    ...
    //////// 人数入力//////////
    const int num_player = 10; // プレイヤーの人数入力/
    const int players = 1023;  //10人の協力ゲーム
    int n_clusters = 15;       //クラスタ数
    /////////////////////////////

    //ファイルの代入 出力
    // ofstream data_file("30_20/teian_custer15.csv");
    // ifstream cparam("30_20/real_c.csv");
    // ifstream  param("30_20/real_a.csv");
    // ifstream sparam("30_20/real_b.csv");

    // ofstream data_file("10_15/teian_custer15.csv");
    ifstream cparam("10_15/real_c_10_15.csv");
    ifstream  param("10_15/real_a_10_15.csv");
    ifstream sparam("10_15/real_b_10_15.csv");

    // ofstream data_file("10_5/teian_custer15.csv");
    ...
    //クラスタ分けに資源ベクトルを代入
    //確定形の先頭アドレスを読み込む
    cv::Mat samples = cv::Mat::zeros(players, 10, CV_32FC1);
